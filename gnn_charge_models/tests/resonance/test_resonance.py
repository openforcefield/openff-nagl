...
from gnn_charge_models.resonance.resonance import (
    FragmentEnumerator,
    ResonanceEnumerator,
)
...
class TestResonanceEnumeratorCase:
    ...
    def enumerator(self):
        return ResonanceEnumerator.from_smiles(
            "[O-][N+](=O)Nc1cccc[n+]1[O-]", mapped=False
        )
...
class TestResonanceEnumeratorMethane:
    ...
    def test_enumerate_resonance_molecules(
        self, enumerator, lowest_energy_only, include_all_transfer_pathways
    ):
