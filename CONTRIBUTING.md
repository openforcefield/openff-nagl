...
We welcome all contributions to GNN Charge Models!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/lilyminium/gnn-charge-models/issues)
...
The second two options both involve making a [pull request](https://github.com/lilyminium/gnn-charge-models/pulls) .
