...
EXAMPLE_UNFEATURIZED_PARQUET_DATASET = (
    data_directory / "example-data-labelled-unfeaturized"
)
EXAMPLE_FEATURIZED_PARQUET_DATASET = data_directory / "example-data-labelled-featurized"
EXAMPLE_UNFEATURIZED_PARQUET_DATASET_SHORT = (
    data_directory / "example-data-labelled-unfeaturized-short"
)
EXAMPLE_FEATURIZED_PARQUET_DATASET_SHORT = (
    data_directory / "example-data-labelled-featurized-short"
)
...
EXAMPLE_FEATURIZED_LAZY_DATA = (
    data_directory
    / "cbe6f394311f594a9df33d7580e8b8478f0aef5b505f16f8b2f6af721a14e30d.arrow"
)
EXAMPLE_FEATURIZED_LAZY_DATA_SHORT = (
    data_directory
    / "b6713a9ba87e89cb53d264256664bb9e4e4a5831f0c7660808e9f44a9f832ab5.arrow"
)
...
MOLECULE_ESP_RECORD_CBR3 = (
    data_directory / "training-data" / "molecule-esp-record-cbr3.json"
)
