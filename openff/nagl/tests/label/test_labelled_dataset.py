...
from openff.nagl.label.labels import LabelConformers, LabelCharges
...
class TestLabelledDataset:
    ...
    def test_from_mapped_smiles(self, tmp_path):
        ...
        dataset = LabelledDataset.from_smiles(tmp_path, smiles, mapped=True)
